...
@Telebot.on_message(filters.command('display_users'))
def display_users(bot: Telebot, message):
    try:
...
@Telebot.on_message(filters.command('display_admins'))
def display_admins(bot: Telebot, message):
    try:
